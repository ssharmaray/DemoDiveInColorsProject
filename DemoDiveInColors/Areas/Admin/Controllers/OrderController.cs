...
namespace DemoDiveInColors.Areas.Admin.Controllers
{
	...
	public class OrderController : Controller
	{
		...
		[HttpPost]
		[Authorize(Roles = SD.Role_User_InternalUser_Admin + "," + SD.Role_User_InternalUser_Employee)]
		[ValidateAntiForgeryToken]
		...
		public IActionResult GetAll(string status)
		{
			...
			if (User.IsInRole(SD.Role_User_InternalUser_Admin) || User.IsInRole(SD.Role_User_InternalUser_Employee))
			{
